...
import static com.savvasdalkitsis.gameframe.injector.usecase.UseCaseInjector.savedDrawingUseCase;
...
public class PresenterInjector {
    ...
    public static DrawPresenter drawPresenter() {
        return new DrawPresenter(gameFrameUseCase(), savedDrawingUseCase());
    }
}

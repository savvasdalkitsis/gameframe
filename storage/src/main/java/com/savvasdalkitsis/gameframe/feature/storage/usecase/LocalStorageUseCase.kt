...
import com.savvasdalkitsis.gameframe.kotlin.InputStreamProvider
import io.reactivex.Completable
import io.reactivex.Single
import org.apache.commons.io.FileUtils
import java.io.*

class LocalStorageUseCase(private val context: Context) {
    ...
    private fun file(name: String) =
            Single.just(File(context.getExternalFilesDir(null), name))
}
